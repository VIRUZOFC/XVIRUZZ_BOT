...
title: "VER LISTA",
description: "Infórmate por medios oficiales sobre X-VIRUS-BOT",
sections: [
{ title: "ℹ️ Información", highlight_label: "Popular",
rows: [
{ header: "✅ Redes", title: "🔓 Para: Todos", description: "Infórmate por medios oficiales sobre X-VIRUS-BOT", id: usedPrefix + "cuentasgb" },
{ header: "📢 Grupos/Canales", title: "🔓 Para: Todos", description: "¡Te esperamos!", id: usedPrefix + "grupos" },
{ header: "🎁 Donar", title: "🔓 Para: Todos", description: "X-VIRUS-BOT se mantiene funcionando gracias a donaciones ¡tú también puedes sumarte apoyando el proyecto!", id: usedPrefix + "donar" }
]},
...
{ header: "👾 Estado", title: "🔓 Para: Todos", description: "Conoce en que estado se encuentra X-VIRUS-BOT", id: usedPrefix + "estado" }
]},
...
┃
*╰━━━━━━━━━━━━━⬣*`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '👾 X-VIRUS-BOT 🦠', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu}}}) 
